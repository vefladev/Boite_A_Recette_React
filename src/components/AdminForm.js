...
const AdminForm = ({
    ...
    return (
        ...
        <form className='admin-form'>
            ...
            <textarea value={recette.ingredients} onChange={e => handleChange(e, key)} name='ingredients'  rows='3' placeholder='Liste de ingrédients' />

            <textarea value={recette.instructions} onChange={e => handleChange(e, key)} name='inscruction' rows='15' placeholder='Liste des instructions' />
